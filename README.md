...
[![tests](https://img.shields.io/badge/tests-383%20passing-0b6e54?style=flat-square)](#verifying-it)
...
| `test` | 383 tests: signature forgery, chain tampering, replay, envelope escape, judge authority, evidence self-verification, rail error handling, write ordering, concurrency, merchant registry loading, mandate lifecycle, Shopify catalog boundary, the documented SDK example |
